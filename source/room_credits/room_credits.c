...
void Room_Credits_Load(void)
{
    ...
    // Load the tiles
    SWI_CpuSet_Copy16(minimap_frame_tiles_tiles, (void *)BG_CREDITS_TILES_BASE,
                      minimap_frame_tiles_tiles_size);

    // Load the map
    SWI_CpuSet_Copy16(credits_bg_map, (void *)BG_CREDITS_MAP_BASE,
                      credits_bg_map_size);
