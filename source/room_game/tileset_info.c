...
static const city_tile_info city_tileset_info[] = {
    ...
    [T_TRAIN_TB] = { TYPE_FIELD | TYPE_HAS_TRAIN, 0, 0, "Train Tracks" },
    [T_TRAIN_LR] = { TYPE_FIELD | TYPE_HAS_TRAIN, 0, 0, "Train Tracks" },
    [T_TRAIN_RB] = { TYPE_FIELD | TYPE_HAS_TRAIN, 0, 0, "Train Tracks" },
    [T_TRAIN_LB] = { TYPE_FIELD | TYPE_HAS_TRAIN, 0, 0, "Train Tracks" },
    [T_TRAIN_TR] = { TYPE_FIELD | TYPE_HAS_TRAIN, 0, 0, "Train Tracks" },
    [T_TRAIN_TL] = { TYPE_FIELD | TYPE_HAS_TRAIN, 0, 0, "Train Tracks" },
    [T_TRAIN_TRB] = { TYPE_FIELD | TYPE_HAS_TRAIN, 0, 0, "Train Tracks" },
    [T_TRAIN_LRB] = { TYPE_FIELD | TYPE_HAS_TRAIN, 0, 0, "Train Tracks" },
    [T_TRAIN_TLB] = { TYPE_FIELD | TYPE_HAS_TRAIN, 0, 0, "Train Tracks" },
    [T_TRAIN_TLR] = { TYPE_FIELD | TYPE_HAS_TRAIN, 0, 0, "Train Tracks" },
    [T_TRAIN_TLRB] = { TYPE_FIELD | TYPE_HAS_TRAIN, 0, 0, "Train Tracks" },
    [T_TRAIN_LR_ROAD] = { TYPE_FIELD | TYPE_HAS_TRAIN | TYPE_HAS_ROAD, 0, 0, "Road + Train Tracks" },
    [T_TRAIN_TB_ROAD] = { TYPE_FIELD | TYPE_HAS_TRAIN | TYPE_HAS_ROAD, 0, 0, "Road + Train Tracks" },
    [T_TRAIN_TB_POWER_LINES] = { TYPE_FIELD | TYPE_HAS_TRAIN | TYPE_HAS_POWER, 0, 0, "Train Tracks + Power\nLines" },
    [T_TRAIN_LR_POWER_LINES] = { TYPE_FIELD | TYPE_HAS_TRAIN | TYPE_HAS_POWER, 0, 0, "Train Tracks + Power\nLines" },
    [T_TRAIN_TB_BRIDGE] = { TYPE_WATER | TYPE_HAS_TRAIN, 0, 0, "Train Tracks Bridge" },
    [T_TRAIN_LR_BRIDGE] = { TYPE_WATER | TYPE_HAS_TRAIN, 0, 0, "Train Tracks Bridge" },
    ...
    [T_POWER_PLANT_COAL + 0] = { TYPE_POWER_PLANT,  0, 0, "Coal Power Plant" },
    [T_POWER_PLANT_COAL + 1] = { TYPE_POWER_PLANT, -1, 0, "Coal Power Plant" },
    [T_POWER_PLANT_COAL + 2] = { TYPE_POWER_PLANT, -2, 0, "Coal Power Plant" },
    [T_POWER_PLANT_COAL + 3] = { TYPE_POWER_PLANT, -3, 0, "Coal Power Plant" },
    [T_POWER_PLANT_COAL + 4] = { TYPE_POWER_PLANT,  0,-1, "Coal Power Plant" },
    [T_POWER_PLANT_COAL + 5] = { TYPE_POWER_PLANT, -1,-1, "Coal Power Plant" },
    [T_POWER_PLANT_COAL + 6] = { TYPE_POWER_PLANT, -2,-1, "Coal Power Plant" },
    [T_POWER_PLANT_COAL + 7] = { TYPE_POWER_PLANT, -3,-1, "Coal Power Plant" },
    [T_POWER_PLANT_COAL + 8] = { TYPE_POWER_PLANT,  0,-2, "Coal Power Plant" },
    [T_POWER_PLANT_COAL + 9] = { TYPE_POWER_PLANT, -1,-2, "Coal Power Plant" },
    [T_POWER_PLANT_COAL + 10] = { TYPE_POWER_PLANT, -2,-2, "Coal Power Plant" },
    [T_POWER_PLANT_COAL + 11] = { TYPE_POWER_PLANT, -3,-2, "Coal Power Plant" },
    [T_POWER_PLANT_COAL + 12] = { TYPE_POWER_PLANT,  0,-3, "Coal Power Plant" },
    [T_POWER_PLANT_COAL + 13] = { TYPE_POWER_PLANT, -1,-3, "Coal Power Plant" },
    [T_POWER_PLANT_COAL + 14] = { TYPE_POWER_PLANT, -2,-3, "Coal Power Plant" },
    [T_POWER_PLANT_COAL + 15] = { TYPE_POWER_PLANT, -3,-3, "Coal Power Plant" },

    [T_POWER_PLANT_OIL + 0] = { TYPE_POWER_PLANT,  0, 0, "Oil Power Plant" },
    [T_POWER_PLANT_OIL + 1] = { TYPE_POWER_PLANT, -1, 0, "Oil Power Plant" },
    [T_POWER_PLANT_OIL + 2] = { TYPE_POWER_PLANT, -2, 0, "Oil Power Plant" },
    [T_POWER_PLANT_OIL + 3] = { TYPE_POWER_PLANT, -3, 0, "Oil Power Plant" },
    [T_POWER_PLANT_OIL + 4] = { TYPE_POWER_PLANT,  0,-1, "Oil Power Plant" },
    [T_POWER_PLANT_OIL + 5] = { TYPE_POWER_PLANT, -1,-1, "Oil Power Plant" },
    [T_POWER_PLANT_OIL + 6] = { TYPE_POWER_PLANT, -2,-1, "Oil Power Plant" },
    [T_POWER_PLANT_OIL + 7] = { TYPE_POWER_PLANT, -3,-1, "Oil Power Plant" },
    [T_POWER_PLANT_OIL + 8] = { TYPE_POWER_PLANT,  0,-2, "Oil Power Plant" },
    [T_POWER_PLANT_OIL + 9] = { TYPE_POWER_PLANT, -1,-2, "Oil Power Plant" },
    [T_POWER_PLANT_OIL + 10] = { TYPE_POWER_PLANT, -2,-2, "Oil Power Plant" },
    [T_POWER_PLANT_OIL + 11] = { TYPE_POWER_PLANT, -3,-2, "Oil Power Plant" },
    [T_POWER_PLANT_OIL + 12] = { TYPE_POWER_PLANT,  0,-3, "Oil Power Plant" },
    [T_POWER_PLANT_OIL + 13] = { TYPE_POWER_PLANT, -1,-3, "Oil Power Plant" },
    [T_POWER_PLANT_OIL + 14] = { TYPE_POWER_PLANT, -2,-3, "Oil Power Plant" },
    [T_POWER_PLANT_OIL + 15] = { TYPE_POWER_PLANT, -3,-3, "Oil Power Plant" },

    [T_POWER_PLANT_WIND + 0] = { TYPE_POWER_PLANT,  0, 0, "Wind Power Plant" },
    [T_POWER_PLANT_WIND + 1] = { TYPE_POWER_PLANT, -1, 0, "Wind Power Plant" },
    [T_POWER_PLANT_WIND + 2] = { TYPE_POWER_PLANT,  0,-1, "Wind Power Plant" },
    [T_POWER_PLANT_WIND + 3] = { TYPE_POWER_PLANT, -1,-1, "Wind Power Plant" },

    [T_POWER_PLANT_SOLAR + 0] = { TYPE_POWER_PLANT,  0, 0, "Solar Power Plant" },
    [T_POWER_PLANT_SOLAR + 1] = { TYPE_POWER_PLANT, -1, 0, "Solar Power Plant" },
    [T_POWER_PLANT_SOLAR + 2] = { TYPE_POWER_PLANT, -2, 0, "Solar Power Plant" },
    [T_POWER_PLANT_SOLAR + 3] = { TYPE_POWER_PLANT, -3, 0, "Solar Power Plant" },
    [T_POWER_PLANT_SOLAR + 4] = { TYPE_POWER_PLANT,  0,-1, "Solar Power Plant" },
    [T_POWER_PLANT_SOLAR + 5] = { TYPE_POWER_PLANT, -1,-1, "Solar Power Plant" },
    [T_POWER_PLANT_SOLAR + 6] = { TYPE_POWER_PLANT, -2,-1, "Solar Power Plant" },
    [T_POWER_PLANT_SOLAR + 7] = { TYPE_POWER_PLANT, -3,-1, "Solar Power Plant" },
    [T_POWER_PLANT_SOLAR + 8] = { TYPE_POWER_PLANT,  0,-2, "Solar Power Plant" },
    [T_POWER_PLANT_SOLAR + 9] = { TYPE_POWER_PLANT, -1,-2, "Solar Power Plant" },
    [T_POWER_PLANT_SOLAR + 10] = { TYPE_POWER_PLANT, -2,-2, "Solar Power Plant" },
    [T_POWER_PLANT_SOLAR + 11] = { TYPE_POWER_PLANT, -3,-2, "Solar Power Plant" },
    [T_POWER_PLANT_SOLAR + 12] = { TYPE_POWER_PLANT,  0,-3, "Solar Power Plant" },
    [T_POWER_PLANT_SOLAR + 13] = { TYPE_POWER_PLANT, -1,-3, "Solar Power Plant" },
    [T_POWER_PLANT_SOLAR + 14] = { TYPE_POWER_PLANT, -2,-3, "Solar Power Plant" },
    [T_POWER_PLANT_SOLAR + 15] = { TYPE_POWER_PLANT, -3,-3, "Solar Power Plant" },

    [T_POWER_PLANT_NUCLEAR + 0] = { TYPE_POWER_PLANT,  0, 0, "Nuclear Power Plant" },
    [T_POWER_PLANT_NUCLEAR + 1] = { TYPE_POWER_PLANT, -1, 0, "Nuclear Power Plant" },
    [T_POWER_PLANT_NUCLEAR + 2] = { TYPE_POWER_PLANT, -2, 0, "Nuclear Power Plant" },
    [T_POWER_PLANT_NUCLEAR + 3] = { TYPE_POWER_PLANT, -3, 0, "Nuclear Power Plant" },
    [T_POWER_PLANT_NUCLEAR + 4] = { TYPE_POWER_PLANT,  0,-1, "Nuclear Power Plant" },
    [T_POWER_PLANT_NUCLEAR + 5] = { TYPE_POWER_PLANT, -1,-1, "Nuclear Power Plant" },
    [T_POWER_PLANT_NUCLEAR + 6] = { TYPE_POWER_PLANT, -2,-1, "Nuclear Power Plant" },
    [T_POWER_PLANT_NUCLEAR + 7] = { TYPE_POWER_PLANT, -3,-1, "Nuclear Power Plant" },
    [T_POWER_PLANT_NUCLEAR + 8] = { TYPE_POWER_PLANT,  0,-2, "Nuclear Power Plant" },
    [T_POWER_PLANT_NUCLEAR + 9] = { TYPE_POWER_PLANT, -1,-2, "Nuclear Power Plant" },
    [T_POWER_PLANT_NUCLEAR + 10] = { TYPE_POWER_PLANT, -2,-2, "Nuclear Power Plant" },
    [T_POWER_PLANT_NUCLEAR + 11] = { TYPE_POWER_PLANT, -3,-2, "Nuclear Power Plant" },
    [T_POWER_PLANT_NUCLEAR + 12] = { TYPE_POWER_PLANT,  0,-3, "Nuclear Power Plant" },
    [T_POWER_PLANT_NUCLEAR + 13] = { TYPE_POWER_PLANT, -1,-3, "Nuclear Power Plant" },
    [T_POWER_PLANT_NUCLEAR + 14] = { TYPE_POWER_PLANT, -2,-3, "Nuclear Power Plant" },
    [T_POWER_PLANT_NUCLEAR + 15] = { TYPE_POWER_PLANT, -3,-3, "Nuclear Power Plant" },

    [T_POWER_PLANT_FUSION + 0] = { TYPE_POWER_PLANT,  0, 0, "Fusion Power Plant" },
    [T_POWER_PLANT_FUSION + 1] = { TYPE_POWER_PLANT, -1, 0, "Fusion Power Plant" },
    [T_POWER_PLANT_FUSION + 2] = { TYPE_POWER_PLANT, -2, 0, "Fusion Power Plant" },
    [T_POWER_PLANT_FUSION + 3] = { TYPE_POWER_PLANT, -3, 0, "Fusion Power Plant" },
    [T_POWER_PLANT_FUSION + 4] = { TYPE_POWER_PLANT,  0,-1, "Fusion Power Plant" },
    [T_POWER_PLANT_FUSION + 5] = { TYPE_POWER_PLANT, -1,-1, "Fusion Power Plant" },
    [T_POWER_PLANT_FUSION + 6] = { TYPE_POWER_PLANT, -2,-1, "Fusion Power Plant" },
    [T_POWER_PLANT_FUSION + 7] = { TYPE_POWER_PLANT, -3,-1, "Fusion Power Plant" },
    [T_POWER_PLANT_FUSION + 8] = { TYPE_POWER_PLANT,  0,-2, "Fusion Power Plant" },
    [T_POWER_PLANT_FUSION + 9] = { TYPE_POWER_PLANT, -1,-2, "Fusion Power Plant" },
    [T_POWER_PLANT_FUSION + 10] = { TYPE_POWER_PLANT, -2,-2, "Fusion Power Plant" },
    [T_POWER_PLANT_FUSION + 11] = { TYPE_POWER_PLANT, -3,-2, "Fusion Power Plant" },
    [T_POWER_PLANT_FUSION + 12] = { TYPE_POWER_PLANT,  0,-3, "Fusion Power Plant" },
    [T_POWER_PLANT_FUSION + 13] = { TYPE_POWER_PLANT, -1,-3, "Fusion Power Plant" },
    [T_POWER_PLANT_FUSION + 14] = { TYPE_POWER_PLANT, -2,-3, "Fusion Power Plant" },
    [T_POWER_PLANT_FUSION + 15] = { TYPE_POWER_PLANT, -3,-3, "Fusion Power Plant" },
